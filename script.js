// script.js - 最终逻辑定稿 (黄金平衡点版本：55% 逻辑纯度)
    ...
    'strength': `
        <div class="detail-card">
            ...
            <ul>
                ...
                <li><strong>破绽利用：：：</strong> 独创**“破绽利用法”**。利用您的背景劣势（如跨专业），打造教授眼中**“无法拒绝的必然性动机”**。</li>
            </ul>
        </div>
    `,
    ...
    'model': `
        <div class="detail-card">
            ...
            <ul>
                ...
                <li><strong>定制化口语：：：</strong> 针对有需求的学生，提供**针对性的日语口语训练**，确保面试气场不掉链子。</li>
...
const qaDatabase = [
    ...
    },
    {
        ...
        answer: "日本硕士学位是**强力加分项**，但最终看重的是你的**“软实力”**。你的毕业目标必须是**“可逆推的”**：从你最终想达到的职业角色，反推出**“你在该专业需要学习的核心技能”**。这才是你研究计划书具备**“逻辑上的必然性”**的证明。同时，要提前将你的研究成果**“商业化翻译”**，链接到具体的业界痛点。"
    },

    // --- 类别 E：文化与具体策略 (区分度最高的条目) ---
    {
