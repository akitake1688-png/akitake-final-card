// script.js - 最终定稿版 (二次优化/去啰嗦/强化引导与秋武老师风格差异化)
...
// 🎯 最终优化版【秋武老师风格随机兜底回复】 (更中肯、更平易、更具信赖感)
const akutakeFallbackResponses = [
    // 【终极模板 1：战略与目标】—— 不谈高熵，直击客户“瞎忙”的心理痛点。
    `这个问题很常见。但我要问你：你真的想解决眼前的问题，还是只是想确认你的努力方向？**AI只能计算已知，但无法帮你设定‘战略偏差’。**你的困惑，需要的是**人对人的诊断**，不是数据罗列。我们直接聊聊你的目标向量，把力气花在刀刃上。` + finalCTA,
    
    // 【终极模板 2：情绪与稀缺性】—— 承认情绪，引入文化和经验的不可替代性。
    `我理解你为什么会问这个。AI的回答再完美，也无法给你**‘独一无二的安心感’**。因为留学是一个‘人对人的博弈’，涉及到**日本文化中的潜台词和情境**。这种**‘不可复制的温度’**，只有真人能提供。我们聊聊你最不确定的那个‘破绽’在哪里。` + finalCTA,
    
    // 【终极模板 3：成本与效率】—— 批判低效，聚焦最昂贵的成本：时间。
    `谢谢你提出这个。AI只能给你‘通用答案’，但通用答案就是最贵的。因为你最昂贵的成本是**时间——你浪费的每一年生命周期**。我的作用不是给你信息，而是为你**设计‘破绽利用法’**，让你立即跳过低效环节。直接加我微信，我们谈效率，不谈通用。` + finalCTA
];
