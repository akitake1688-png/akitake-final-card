// script.js - 最终定稿版 (集大成/全覆盖/左侧内容终极优化)
...
const contentData = {
    'strength': `
        <div class="detail-card">
            ...
            <ul>
                <li><strong>高维逻辑：：</strong> **理工思维 x 农学修士**。不是简单留学中介，而是用**“向量逻辑”**对您的文科叙事进行降维重构。</li>
                <li><strong>破绽利用：：</strong> 独创**“破绽利用法”**。将双非背景或跨专业劣势，转化为教授眼中**“无法拒绝的跨学科动机”**。你所有的“弱”点，都将成为独家叙事的**“破绽”**。</li>
                <li><strong>高情商解码：：</strong> 只有东大前辈才懂的**“情境潜规则”**。我教你识别教授邮件中的**“建前”（客套话）**与**“本音”（真心话）**。</li>
            </ul>
        </div>
    `,
    'model': `
        <div class="detail-card">
            <h3>**契约精神：** 高效稀缺化辅导模式解析</h3>
            <ul>
                <li><strong>1:1 师徒制：：</strong> 拒绝流水线式申请。我们只建立**“认知契约”**，核心在于解决您底层**“思维偏差”**，而非信息不对称。</li>
                <li><strong>【强推】免佣直通车：：</strong> 这是最高效的**“信用置换”**。利用我在业界的**“信用背书”**，直接送你进合作机构，<span style="color:#d9534f; font-weight:bold;">费用由机构承担</span>。省时、省钱、安全。</li>
                <li><strong>最终目标：：</strong> 我们的目标不是“递交材料”，而是帮助您在教授面前取得**“心理博弈的胜利”**，让你的努力充满**“余裕”（遊び）**。</li>
            </ul>
        </div>
    `,
    'cases': `
        <div class="detail-card">
            ...
            <p style="margin-bottom: 15px;">留学申请的成功是**一场认知战**。建议深度阅读我的专栏，获取**不可复制**的认知差和实战策略：</p>
...
const storyCardData = {
    ...
    'result_interview': {
        ...
        result: `
            ...
            <p><strong>【破局心理学】:</strong></p>
            <p>我们将进行**“防御性悲观”**训练。我会教您如何听懂教授问题的“弦外之音”（比如他问你“在这个领域有无其他兴趣”，其实可能是在暗示你的题目太窄）。掌握了这些暗号，面试就是一场愉快的聊天。</p>
    ...
    'result_channel': {
        title: '💡 诊断：您需要建立“信任契约”',
        result: `
            <p>您的焦虑是**“信息不对称”**的必然结果。在日本社会，<strong>“信用”（Shinyo）</strong>是您唯一的安全资产，比金钱更昂贵。</p>
            <p><strong>【破局心理学】:</strong></p>
...
// 🎯 终极精炼版【秋武老师风格随机兜底回复】 (去除共情话术，直接切入核心)
const akutakeFallbackResponses = [
    // 【模板 1：战略与目标】
    `这个问题很常见。但我要问你：你真的想解决眼前的问题，还是只是想确认你的努力方向？**AI只能计算已知，但无法帮你设定‘战略偏差’。**你的困惑，需要的是**人对人的诊断**。我们直接聊聊你的目标向量，把力气花在刀刃上。` + finalCTA,
    
    // 【模板 2：情绪与稀缺性】
    `这个问题普遍存在。AI的回答再完美，也无法给你**‘独一无二的安心感’**。因为留学是一个‘人对人的博弈’，涉及到**日本文化中的潜台词和情境**。这种**‘不可复制的温度’**，只有真人能提供。我们聊聊你最不确定的那个‘破绽’在哪里。` + finalCTA,
    
    // 【模板 3：成本与效率】
    `这是一个通用性问题。但通用答案就是最贵的，因为它会浪费你最昂贵的成本：**时间——你浪费的每一年生命周期**。我的作用是为你**设计‘破绽利用法’**，让你立即跳过低效环节。直接加我微信，我们谈效率，不谈通用。` + finalCTA
];
