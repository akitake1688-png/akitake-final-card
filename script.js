    ...
    'model': `
        <div class="detail-card">
            ...
            <ul>
                ...
                <li><strong>最终目标：：</strong> 我们的目标不是“递交材料”，而是帮助您在教授面前取得**“心理博弈的胜利”**，让您的努力充满**“余裕”（遊び）**。</li>
            </ul>
        </div>
    `,
    'cases': `
        <div class="detail-card">
            ...
            <p style="margin-bottom: 15px;">留学申请的成功是**一场认知战**。建议您深度阅读我的专栏，获取**不可复制**的认知差和实战策略：</p>
...
const qaDatabase = [
    ...
    },
    {
        ...
        answer: "日本面试的底层逻辑是**“减分制”**与**“压力测试”**。教授不仅在听内容，更在观察您的**“非语言信号”**。<br><br>甚至在您进门敲门的那三秒，胜负可能已经定了。这涉及到日本文化中的**“身だしなみ”（Midashinami）**。<br>我首创的**【前30秒非语言博弈训练】**，通过调整您的眼神落点、坐姿重心和声音频率，让您在气场上表现出一种“虽然我是学生，但我已经准备好成为研究者”的稳重感。"
    },
    {
...
// 🎯 终极精炼版【秋武老师风格随机兜底回复】 (风格固化，使用“您”字和“安全边界”)
