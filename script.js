// script.js - 最终完整版：东大秋武老师数字卡 (高情商 & 核心价值优化版)
    ...
    'strength': `
        <div class="detail-card">
            ...
            <ul>
                ...
                <li><strong>化“弱”为“强”：** 独创“破绽利用法”。我不掩盖你的劣势，而是将你经历中的“矛盾点”转化为最吸引教授的“研究动机”。</li>
                <li>**东大底层逻辑：</strong> 深入破解日本顶级学府的“潜规则”，提供符合“东大基准”的逻辑重构。</li>
                <li>**非语言博弈：</strong> 独创“坐姿/眼神/递交材料”全真模拟，在面试的前30秒赢下心理战。</li>
            </ul>
        </div>
    `,
    'model': `
        <div class="detail-card">
            ...
            <ul>
                ...
                <li><strong>无限时服务：** 不按课时算钱，只为最终合格率负责。</li>
            </ul>
        </div>
    `,
    'cases': `
...
// ==========================================
// 第二部分：右侧 AI 咨询室逻辑 (深度问答库 - 东大名师人设版)
// ==========================================
