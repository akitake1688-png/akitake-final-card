...
const qaDatabase = [
    // --- 类别 A：身份与价值锚定 ---
    {
        ...
        answer: "这是一个关于**信任**的核心问题。我必须诚实地澄清：我是**东大修士（学际信息/交叉研究室）毕业**，拥有10年一线辅导经验。 <br><br> 虽然我不是博士，但我拥有稀缺的**【理工科入口 + 文科研究】**的跨学科背景。在考学实战中，我提供的**“向量逻辑重构”**，能为您带来**高效率的合格实绩**，这是我的价值保证。" // <<<--- [已修正：措辞降低强度]
    },
    {
        keywords: ['费用', '钱', '收费', '价格', '贵吗', '多少钱', '免费模式', '溢价', '隐形成本'],
        answer: "问得好，我的价格基于**稀缺价值**。<strong>平时辅导需单独付费，具体价格根据项目而定。</strong>但我们有**“费用置换”**模式：通过我的渠道进入合作私塾或语言学校，机构支付的介绍费**等同于替您支付了我的辅导费用**。**高效**是降低留学**隐形成本**的关键。" // <<<--- [已修正：移除“低效最贵”]
    },
    {
        keywords: ['优势', '特点', '区别', '辅导模式', '服务范围', '渠道', '中介', '机构'],
        answer: "多数机构注重**流程化服务**，我的核心价值在于**“认知重构”**。<br><br>我的核心优势源于我独特的学术轨迹：我是**理工科入口、东大修士**，用**工程学的严密逻辑**去降维重构您的课题。至于服务模式，我们提供**“费用置换”**模式：机构的介绍费将**等额抵消**您的秋武老师辅导费用，为您提供最高效率的解决方案。" // <<<--- [已修正：更中肯的对比]
    },
    ...
    },
    {
        ...
        answer: "日本硕士学位是**有力的加分项**，但最终看重的是你的**“软实力”**。你的毕业目标必须是**“可逆推的”**：从你最终想达到的职业角色，反推出**“你在该专业需要学习的核心技能”**。这才是你研究计划书具备**“逻辑上的必然性”**的证明。同时，要提前将你的研究成果**“商业化翻译”**，链接到具体的业界痛点。" // <<<--- [已修正：移除“强力加分项”]
    },
...
const strategicFallbackResponses = [
    `真正的高效辅导，必须结合**日本文化中的情境与教授的个体差异**，这是AI无法提供的**‘专业判断力’**。您的困惑，需要的是**人对人的诊断**。我们聊聊您最不确定的那个‘破绽’在哪里。` + finalCTA, // <<<--- [已修正：更中肯，避免夸大AI限制]
    `策略性偏差往往是最高昂的隐形成本。我的核心价值是**矫正目标向量**，帮您立即进入高效轨道。AI只能计算已知，但无法帮您设定‘战略偏差’。` + finalCTA, // <<<--- [已修正：更专业]
    `与其让您在迷茫中浪费时间，不如直接锁定核心问题。我的作用是为您**设计‘破绽利用法’**，让您立即跳过低效环节。直接加我微信，我们谈效率，不谈通用。` + finalCTA // <<<--- [已修正：更中肯，基于效率]
];
