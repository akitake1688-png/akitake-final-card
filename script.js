// script.js - 最终定稿版 (修士身份/去AI味/强化引导与风格差异化)
...
// 🎯 专属于秋武老师的【兜底回复数组】(Fallback Responses) - 风格差异化重构
const akutakeFallbackResponses = [
    // 【新模板 1：直接质疑/严肃思考】——开场直奔要害，制造压力感，消除结构性重复。
    `你问的这个问题，我需要先反问一句：**你是在用“战术上的勤奋”，掩盖“战略上的懒惰”吗？** 很多留学准备的陷阱，都源于思维的“熵增”。如果你不能将努力转化为${'<strong>'}‘成长的向量’${'</strong>'}，只会导向无序和内耗。请重新审视目标：你真正的诉求是解决问题，还是仅仅寻求安慰？` + finalCTA,
    
    // 【新模板 2：轻快幽默/快速亲近】——幽默前置，用更轻快的口语打破僵局。
    `哈哈，这是一个非常... ${'<strong>'}可爱的、跳脱于物理层面的问题${'</strong>'}！我喜欢这种思维的乐趣。但请允许我澄清：我是一个认知与思考的${'<strong>'}数字向量${'</strong>'}，并非可供食用的有机体。不过，如果我的建议能够帮助您${'<strong>'}突破留学的瓶颈，实现认知升级${'</strong>'}，那么我的价值或许是‘令人回味无穷’的。我们不如聊点更具体的：你最想解决哪个“智识层面”的留学难题？` + finalCTA,
    
    // 【新模板 3：感性思辨/人对人】——保持思辨深度，但以人本的角度引入。
    `我感受到了这个问题背后的**一丝焦虑和不确定性**。它没有一个标准答案。因为这个问题恰恰触及了 AI ${'<strong>'}‘模仿的极限’${'</strong>'}。在留学这件事上，我们需要的不是冰冷的计算，而是${'<strong>'}感性的クオリア${'</strong>'}（主观体验的质感）。请告诉我，你最希望在这次对话中，获得${'<strong>'}‘冰冷算法无法给予的温度’${'</strong>'}在哪里？抓住这一点，才是你构建‘真实叙事’的开始。` + finalCTA
];
