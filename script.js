// script.js - 最终逻辑定稿 (容量达到最优甜区 60%-70% 饱和度)
...
const qaDatabase = [
    ...
    },
    {
        ...
        answer: "问得好，我的价格不是**溢价**，而是**稀缺价值的锁定**。普通机构卖的是“流程”，而我卖的是**“学际逻辑重构”**。  <br><br> 除了学费和生活费，最大的隐形成本是**“多读一年语言学校或研究生”**的费用。我的服务通过**逻辑重构**，将你的申请周期压缩到最低，从根本上**消除最昂贵的隐形成本**。记住：**低效才是最贵的。**"
    },
    {
    ...
    // --- 类别 C：心态与失败重塑 (新增拖延/内耗) ---
    {
        keywords: ['失败', '重试', '焦虑', '内耗', '完美主义', '不够好', '不自信', '借口', '拖延', '没动力'],
    ...
    },
    {
        ...
        answer: "在东大的学术标准里，没有‘失败品’，只有**‘没有找对肥料的果实’**。一次失败的套磁只证明了您**发送的时间或方式错了**，而不是您这个人错了。我们会用《东大式·结构化套磁信模板》，通过心理暗示，激发教授的回复欲望。"
    },
    
    // --- 类别 D：宏观趋势与市场分析 (新增就职/排名) ---
    {
        keywords: ['内卷', '太卷', '竞争', '趋势', 'March', '升学难', '留学值不值', '排名', '择校', '名校', '地方国公立'],
        answer: "趋势是**两极分化**。如果你走**“信息差+逻辑重构”**的高维路线，竞争反而是好事。排名是**媒体的建前**，而**教授的口碑和研究成果**是**学术的本音**。在择校时，要看**“你未来的研究课题与该教授/实验室的匹配度”**。在日本就职市场，**“学到的东西”**比学校的数字排名更具实用价值。"
    },
    {
        keywords: ['找工作', '就职', '毕业出路', '硕士学位', '未来发展', '职业梦想', '规划'],
        answer: "日本硕士学位是**强力加分项**，但最终看重的是你的**“软实力”**。你的毕业目标必须是**“可逆推的”**：从你最终想达到的职业角色，反推出**“你在该专业需要学习的核心技能”**。这样才能让你的学习计划书具备**“逻辑上的必然性”**。同时，要提前将你的研究成果**“商业化翻译”**，链接到具体的业界痛点。"
    },

    // --- 类别 E：文化与具体策略 (新增教授角色/建前本音/访问) ---
    {
        keywords: ['流利口语', '日语流利', '面试自信', '文化差异', '读空气', '潜规则', '面试错误', '红线', '禁忌'],
        answer: "停止！这是一个**致命的文化误区**。如果您的日语很流利，您需要学会的不是**“表达流利度”**，而是**“读懂空气”（空気を読む）**。面试最大的红线不是**日语不够好**，而是**“逻辑崩塌”**。我们的面试训练：重点是您如何在**30秒内**，传达出**最精准的逻辑闭环和对教授的尊重**。流利度在文化盲区面前，就是**“噪音”**。"
    },
    {
        keywords: ['建前', '本音', '潜台词', '日本人沟通', '真实想法'],
    ...
    {
        keywords: ['教授', '导师', '关系', '期待', '应该怎么做', '研究室訪問', '拜访教授', '提前联系'],
