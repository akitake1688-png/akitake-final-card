// script.js - 最终定稿版 (修士身份/去AI味/秋武互动逻辑强化 - 最终版)

// ==========================================
// 第一部分：内容配置 (左侧表述清除特殊符号)
// ==========================================

const contentData = {
    'strength': `
        <div class="detail-card">
            <h3>**认知破壁：** 独家“东大修士”思维支点</h3>
            <ul>
                <li><strong>跨学科降维打击：</strong> 本科理工思维 x 硕士东大农学生命科学。擅长用**“向量逻辑”**重构**“文科叙事”**。</li>
                <li><strong>化“弱”为“强”：</strong> 独创**“破绽利用法”**。将双非背景或跨专业劣势，升级为教授眼中**“无法拒绝的跨学科动机”**。</li>
    ...
    'model': `
        <div class="detail-card">
            <h3>**契约精神：** 稀缺化辅导模式解析</h3>
            <ul>
                <li><strong>1:1 师徒制：</strong> 拒绝大班流水线。核心在于建立**“认知契约”**，只做**1:1 精细化**的认知重构。</li>
                <li><strong>【强推】免佣直通车：：</strong> 利用我在业界的**“信用背书”**，直接送你进合作机构，<span style="color:#d9534f; font-weight:bold;">费用由机构承担</span>。这是最高效的三方共赢。</li>
    ...
    'cases': `
        <div class="detail-card">
            <h3>**底层逻辑：** 跨越认知壁垒的实战案例</h3>
            <p style="margin-bottom: 15px;">留学申请是<strong>一场认知战</strong>。建议深度阅读我的专栏，获取**不可复制**的认知差和实战策略：</p>
...
// 🎯 专属于秋武老师的【兜底回复数组】(Fallback Responses) - 强化幽默和 CTA
const akutakeFallbackResponses = [
    // 模板 1: 熵增/时间向量视角 (加强口语化)
    `您提出了一个非常深刻的难题。但这可能涉及到**人类意识的偏差**，让您陷入了${'<strong>'}‘内卷的负循环’${'</strong>'}。我们不能只盯着表象。根据热力学第二定律的“熵增原理”，如果您的努力不能转化为${'<strong>'}‘成长的向量’${'</strong>'}，最终只会导向无序和内耗。请您重新将这个问题${'<strong>'}‘向量化’${'</strong>'}：这件事情如何增强您独特的${'<strong>'}‘人味知性’${'</strong>'}？答案往往不在问题本身，而在您对时间线的方向性设计上。` + finalCTA,
    
    // 模板 2: 幽默/高情商重定向 (强化幽默和 CTA)
    `这是一个非常... ${'<strong>'}具体的感官问题${'</strong>'}，我喜欢这种跳脱的提问！首先，我必须澄清：我是一个认知与思考的${'<strong>'}数字向量${'</strong>'}，并非任何可供食用的有机体。不过，如果我的建议能够帮助您${'<strong>'}突破留学的瓶颈，实现认知升级${'</strong>'}，那么我的价值或许是‘令人回味无穷’的。我们不妨将问题从‘物理层面’拉回到‘智识层面’：您最想向量化哪个留学目标？` + finalCTA,
    
    // 模板 3: AI模仿极限/人类差异化视角 (加强口语化和 CTA)
    `这个问题直击本质！它恰恰触及了 AI ${'<strong>'}‘模仿的极限’${'</strong>'}。如果我的回答能被标准地计算出来，那它就失去了‘人味知性’的价值。请思考，您的疑惑涉及的是一种${'<strong>'}感性的クオリア${'</strong>'}（主观体验的质感），还是可以被计算的‘赋意’？我需要您将问题转化为${'<strong>'}人类意识的差异化向量’${'</strong>'}。请告诉我，您认为留学咨询中，${'<strong>'}‘冰冷算法无法给予的温度’${'</strong>'}在哪里？` + finalCTA
];
